...
export default function BuyerForm() {
    ...
    const getSession = async () => {
        ...
        const currSession = await supabase.auth.getUser();
        console.log(currSession);
        if (currSession.error)
            return false;
        setSession(currSession.data.user);
        return true;
    }
    ...
    const handleInputChange = (key: keyof BuyerFormData, value: string | string[] | undefined) => {
        setFormData(prev => ({
            ...prev,
            [key]: value
        }));
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const buyerData: Omit<buyers, 'updatedAt'> = {
                id: uuidv4(),
                        ...
                        <div className="grid md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input
                                    ...
                                    className={`w-full text-black px-4 py-3 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all ${errors.fullName ? 'border-red-500' : 'border-gray-300'
                                        }`}
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    className={`w-full text-black px-4 py-3 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all ${errors.email ? 'border-red-500' : 'border-gray-300'
                                        }`}
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    className={`w-full px-4 py-3 border text-black rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all ${errors.phone ? 'border-red-500' : 'border-gray-300'
                                        }`}
                            ...
                            <div>
                                ...
                                <select
                                    ...
                                    className={`w-full text-black px-4 py-3 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all ${errors.city ? 'border-red-500' : 'border-gray-300'
                                        }`}
                                >
                            ...
                            <div className="grid md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <select
                                        ...
                                        className={`w-full px-4 text-black py-3 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all ${errors.propertyType ? 'border-red-500' : 'border-gray-300'
                                            }`}
                                    >
                                ...
                                {['Apartment', 'Villa'].includes(formData.propertyType) && (
                                    <div>
                                        ...
                                        <select
                                            ...
                                            className={`w-full text-black px-4 py-3 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all ${errors.bhk ? 'border-red-500' : 'border-gray-300'
                                                }`}
                                        >
                                ...
                                <div>
                                    ...
                                    <select
                                        ...
                                        className={`w-full text-black px-4 py-3 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all ${errors.purpose ? 'border-red-500' : 'border-gray-300'
                                            }`}
                                    >
                            ...
                            <div className="grid md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        className={`w-full text-black px-4 py-3 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all ${errors.budgetMax ? 'border-red-500' : 'border-gray-300'
                                            }`}
                                        placeholder="₹ 0 (optional)"
                                    />
                            ...
                            <div className="space-y-6">
                                <div>
                                    ...
                                    <select
                                        ...
                                        className={`w-full text-black px-4 py-3 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all ${errors.source ? 'border-red-500' : 'border-gray-300'
                                            }`}
                                    >
                                ...
                                <div>
                                    ...
                                    <select
                                        ...
                                        className={`w-full text-black px-4 py-3 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all ${errors.status ? 'border-red-500' : 'border-gray-300'
                                            }`}
                                    >
                                ...
                                <div>
                                    ...
                                    <div className="flex gap-2 mb-3">
                                        <input
                                            ...
                                            className="flex-1 px-4 text-black py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
